        ...
        <S.Container>
            ...
            <S.Container1>
                <S.Detail1>
                    ...
                    <S.Content>
                        <form>
                            <SelectBox options={genderOptions} selectedValue={selectedGender} onChange={handleGenderChange} className="select1" />
                        </form>
                    </S.Content>
                </S.Detail1>
                ...
                <S.Detail2>
                    ...
                    <S.Content>
                        <S.Box>
                            <NicknameInput checkNicknameAvailability={checkNicknameAvailability} />
                        </S.Box>
                    </S.Content>
                </S.Detail2>
                ...
                <S.Detail3>
                    ...
                    <S.BirthdayContent>
                        <form>
                            <SelectBox options={yearOptions} selectedValue={selectedYear} onChange={handleYearChange} className="select1" />
                        </form>
                        <form>
                            <SelectBox options={monthOptions} selectedValue={selectedMonth} onChange={handleMonthChange} className="select1" />
                        </form>
                        <form>
                            <SelectBox options={dateOptions} selectedValue={selectedDate} onChange={handleDateChange} className="select1" />
                        </form>
                    </S.BirthdayContent>
                </S.Detail3>
            ...
            <S.Container3>
                <S.Detail1>
                    ...
                    <S.LocationContent>
                        <form>
                            <SelectBox options={cityOptions} selectedValue={selectedCity} onChange={handleCityChange} className="select2" />
                        </form>
                        <form>
                            <SelectBox options={gymOptions} selectedValue={selectedGym} onChange={handleGymChange} className="select3" />
                        </form>
                    </S.LocationContent>
                </S.Detail1>
